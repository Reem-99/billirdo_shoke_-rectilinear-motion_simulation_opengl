	...
	void update(){
		if (is_running && is_hit){		
			...
			if (rotate)
			{
				...
				/*if (omiga.x< 1 && omiga.x>-1 && omiga.y<1 && omiga.y>-1){
					tita = 0;
					rotate = false;
				}*/
			}
...
void move_after_shock(Ball *ball1, Ball *ball2)
{
	if (ball1->position.x == ball2->position.x && ball1->position.y != ball2->position.y || ball1->position.y == ball2->position.y && ball1->position.x != ball2->position.x){
		...
		//ball1->arm = un.mul(ball1->radius);
		//ball2->arm = un.mul(-1*ball2->radius);
	}
}
...
int InitGL(GLvoid)										// All Setup For OpenGL Goes Here
{
	...
	balls[0].position.z = -15.4;
	 /*for (int i = 1; i < numberOfBalls; i++)
	 {
		 ...
		 balls[i].position.y = -6+2*i;
		 balls[i].position.z = -15.4;
	 }**/
	/*if (numberOfBalls == 8){
		balls[1].position.x = startTableX + (width_table / 2);
		balls[1].position.y = startTableY + (high_table / 2);
		balls[1].position.z = -15.4;
		balls[2].position.x = (startTableX + (width_table / 2)) - 1;
		balls[2].position.y = startTableY + (high_table / 2) + 0.7;
		balls[2].position.z = -15.4;
		balls[3].position.x = (startTableX + (width_table / 2)) - 1;
		balls[3].position.y = startTableY + (high_table / 2) - 0.7;
		balls[3].position.z = -15.4;
		balls[4].position.x = (startTableX + (width_table / 2)) - 3.2;
		balls[4].position.y = startTableY + (high_table / 2) - 1.4;
		balls[4].position.z = -15.4;
		balls[5].position.x = (startTableX + (width_table / 2)) - 1.9;
		balls[5].position.y = startTableY + (high_table / 2);
		balls[5].position.z = -15.4;
		balls[6].position.x = (startTableX + (width_table / 2)) - 1.9;
		balls[6].position.y = startTableY + (high_table / 2) + 1.4;
		balls[6].position.z = -15.4;
		balls[7].position.x = (startTableX + (width_table / 2)) - 1.9;
		balls[7].position.y = startTableY + (high_table / 2) - 1.4;
		balls[7].position.z = -15.4;
	}
	else if (numberOfBalls == 7){
		balls[1].position.x = startTableX + (width_table / 2);
		balls[1].position.y = startTableY + (high_table / 2);
		balls[1].position.z = -15.4;
		balls[2].position.x = (startTableX + (width_table / 2)) - 1;
		...
		balls[3].position.y = startTableY + (high_table / 2) - 0.7;
		balls[3].position.z = -15.4;
		balls[4].position.x = (startTableX + (width_table / 2)) - 1.9;
		balls[4].position.y = startTableY + (high_table / 2);
		balls[4].position.z = -15.4;
		balls[5].position.x = (startTableX + (width_table / 2)) - 1.9;
		balls[5].position.y = startTableY + (high_table / 2) + 1.4;
		balls[5].position.z = -15.4;
		balls[6].position.x = (startTableX + (width_table / 2)) - 1.9;
		balls[6].position.y = startTableY + (high_table / 2) - 1.4;
		balls[6].position.z = -15.4;
	}
	else if (numberOfBalls == 6){
		balls[1].position.x = startTableX + (width_table / 2);
		balls[1].position.y = startTableY + (high_table / 2);
		balls[1].position.z = -15.4;
		balls[2].position.x = (startTableX + (width_table / 2)) - 1;
